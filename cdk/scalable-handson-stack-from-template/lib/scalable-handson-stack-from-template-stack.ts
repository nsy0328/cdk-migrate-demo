...
export interface ScalableHandsonStackFromTemplateStackProps extends cdk.StackProps {
  /**
   * User Name
   * @default 'user1'
   */
 ...
 * Scalable website
 */
export class ScalableHandsonStackFromTemplateStack extends cdk.Stack {
  /**
   * The Instance ID
   */
  ...
  public constructor(scope: cdk.App, id: string, props: ScalableHandsonStackFromTemplateStackProps) {
